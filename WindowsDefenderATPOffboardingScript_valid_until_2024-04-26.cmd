...
%windir%\System32\reg.exe query "HKLM\SOFTWARE\Microsoft\Windows Advanced Threat Protection\Status" /v OrgId | %windir%\System32\find.exe /i "e3986a6a-a1eb-4860-a265-768eb963c995" >NUL 2>&1
if %ERRORLEVEL% NEQ 0 (  
    set "errorDescription=Offboarding script for org e3986a6a-a1eb-4860-a265-768eb963c995. Machine is onboarded to a different org."
    set errorCode=70
    set lastError=%ERRORLEVEL%
    GOTO ERROR
)
